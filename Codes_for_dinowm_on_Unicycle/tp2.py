...
def main():
    ...
    parser.add_argument("--data_root", type=str,
                        default="/storage/scratch1/6/rjiang77/DINOv2_patch_224/2_21_dataset")
    ...
    parser.add_argument("--ckpt_dir", type=str, default="/storage/scratch1/6/rjiang77/My_DINO_WM_RESULTS/Checkpoints/3_14_4")
