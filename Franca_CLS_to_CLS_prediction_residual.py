...
class LatentDynamics(nn.Module):
    def __init__(self, state_dim=768, control_dim=2):
        ...
        self.fc = nn.Sequential(
            nn.Linear(state_dim + control_dim, 1024),
            nn.ReLU(),
            ...
            nn.LayerNorm(1024),         # ← NEW LayerNorm
            nn.ReLU(),
    ...
    def forward(self, z, u):
        return z + self.fc(torch.cat([z, u], dim=-1))
...
def train(
    ...
    h5_path = "/storage/scratch1/6/rjiang77/half_dataset/half_dataset.h5"
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % 20 == 0:
            ...
            torch.save(dyn.state_dict(), "CLS768_2_CLS_1_23_latent_dynamics.pth")
...
if __name__ == "__main__":
    ...
    save_path = './autoencoder/1_31_5_CLS_2_CLS/'
