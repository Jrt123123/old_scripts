...
def state_to_patchtokens(
    ...
    _, patches = dinov2.extract_cls_and_patches([img], batch_size=dino_batch_size,layer = layer)
    # expected: (1, P, D)
    return patches[0]
...
def main():
    ...
    # ckpt_path = "/storage/scratch1/6/rjiang77/My_DINO_WM_RESULTS/Checkpoints/3_14_1/model_0072.pt"      #384d 
    ckpt_path = "suaudojabfiabdB Fkabd;fhkdsbghnveFVHEgfcbhkfl"
    ...
    ap.add_argument("--opt_steps", type=int, default=10)
    ...
    z0_pd = state_to_patchtokens(
        dinov2, args.x0, args.y0, args.th0, args.image_size, args.radius,layer = args.layer
    )
    zg_pd = state_to_patchtokens(
        dinov2, args.xg, args.yg, args.thg, args.image_size, args.radius,layer =args.layer
    )
